    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown dropdown-list-toggle">
            <a href="#" data-bs-toggle="dropdown" class="nav-link nav-link-lg">
                ...
                <span class="badge headerBadge1 bg-success">
                    ৳ {{ number_format($employeeBalance ?? 0, 2) }}
                </span>
            </a>
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
                ...
                <div class="dropdown-list-content dropdown-list-icons">
                    ...
                    <a href="{{ route('employee.beneficiaries') }}" class="dropdown-item">
                ...
                <div class="dropdown-footer text-center">
                    <a href="{{ route('employee.statement') }}">
        ...
        <li class="dropdown dropdown-list-toggle">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
                ...
                <div class="dropdown-list-content dropdown-list-icons">
                    ...
                    <!-- Add the rest of the notifications similarly -->
                </div>
                <div class="dropdown-footer text-center">
        ...
        <li class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
                ...
                <a href="{{ route('employee.profile') }}" class="dropdown-item has-icon">
