...
<section class="section">
    <div class="section-header">
        <h1>Import Product Companies From Excel File</h1>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 border-right">
                    ...
                    <ul>
                        ...
                        <li><strong>company_order</strong></li>
                        <li><strong>status</strong> (1 = Active, 0 = Inactive)</li>
                    </ul>

                    <a href="{{ route('product_company.sample.download') }}" 
                ...
                <div class="col-md-6">
                    ...
                    <form action="{{ route('product_company.import.store') }}" 
                          method="POST" 
